...
# Fix issue: UnicodeDecodeError: 'ascii' codec can't decode byte 0xe6 in position 0: ordinal not in range(128)
import sys
...
class Generate(object):
    ...
    def __init__(self):
        ...
        self._tags = []
        self._categories = []
        self.env = Environment(loader=FileSystemLoader("./web/templates"))
